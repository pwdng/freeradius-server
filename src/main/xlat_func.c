 ...
 */
static xlat_action_t xlat_sha1(TALLOC_CTX *ctx, fr_cursor_t *out,
			       REQUEST *request, UNUSED void const *xlat_inst, UNUSED void *xlat_thread_inst,
			       fr_value_box_t **in)
{
 ...
 */
static xlat_action_t xlat_hmac_md5(TALLOC_CTX *ctx, fr_cursor_t *out,
				   REQUEST *request, void const *xlat_inst, void *xlat_thread_inst,
				   fr_value_box_t **in)
{
	uint8_t		digest[MD5_DIGEST_LENGTH];
 ...
 */
static xlat_action_t xlat_hmac_sha1(TALLOC_CTX *ctx, fr_cursor_t *out,
				    REQUEST *request, void const *xlat_inst, void *xlat_thread_inst,
				    fr_value_box_t **in)
{
	uint8_t		digest[SHA1_DIGEST_LENGTH];
 ...
 */
static xlat_action_t xlat_pairs(TALLOC_CTX *ctx, fr_cursor_t *out,
								REQUEST *request, UNUSED void const *xlat_inst, UNUSED void *xlat_thread_inst,
 								fr_value_box_t **in)
{
	vp_tmpl_t	*vpt = NULL;
	...
	if (tmpl_afrom_attr_str(ctx, &vpt, (*in)->vb_strvalue, &(vp_tmpl_rules_t){ .dict_def = request->dict }) <= 0) {
		RPEDEBUG("Invalid input");
		return XLAT_ACTION_FAIL;
	}
...
#define XLAT_ASYNC_REGISTER(_x) xlat_async_register(NULL, STRINGIFY(_x), xlat_ ## _x, NULL, NULL, NULL, NULL, NULL, NULL, NULL); \
	...
	xlat_async_register(NULL, "pairs", xlat_pairs, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
#  endif
	...
	xlat_async_register(NULL, "hmacmd5", xlat_hmac_md5, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	xlat_async_register(NULL, "hmacsha1", xlat_hmac_sha1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
